...
public class ProgressBarFrame extends JFrame{
	...
	public ProgressBarFrame(String fileName) {
		...
		progressBar = new JProgressBar(0, 100);  //상태바 처음값, 마지막값
		progressBar.setPreferredSize(new Dimension(350, 20)); //사이즈 지정해주는거
		progressBar.setStringPainted(true);   	//상태바 진행하기위한..?(색변하는거)
	...
	public void setProgress(int value){  //백분률(파라미터)
