...
public class FTPClient {
	...
	public static final String SERVER = "127.0.0.1";  //로컬로
	...
	public void fileDownload() throws IOException{
		...
		// 파일 데이터 수신
		String downloadDirectory = "C:/Users/KOSTA/Downloads";  //파일다운로드 위치
	...
	public static void main(String[] args) throws UnknownHostException {
		...
		try {
			client.connect();								//파일 연결
			System.out.println("FTPServer Connected.....");
			
			client.fileDownload();							//여기에 콘솔창에 파일리스트 이름들을 텍스트로 보여줄수있는 코드들 있긔
